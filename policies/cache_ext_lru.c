...
int main(int argc, char **argv) {
	...
	if (cache_ext_lru_bpf__load(skel)) {
	...
	link = bpf_map__attach_cache_ext_ops(skel->maps.lru_ops, cgroup_fd);
	if (link == NULL) {
	...
	if (cache_ext_lru_bpf__attach(skel)) {
