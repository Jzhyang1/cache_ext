...
def page_only_markov_model_log_files(logfile_ref, logfile_pred, cache_size, lookahead_size, context_size, max_steps):
    models = []
...
if __name__ == "__main__":
    ...
    page_only_markov_model_log_files(args.logfile_ref, args.logfile_pred, args.cache_size, args.lookahead_size, args.context_size, args.max_steps)